    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: levelIndex <= currentIndex
                ? const AssetImage(ZnAppImages.levelOpen)
                : const AssetImage(ZnAppImages.levelClose),
